A renderer that draws (semi) transparent circles and rectangles. Shapes have 3D coordinates and the order along Z axis
matters for the correct rendering. A pixel belongs to a circle if its center is within the circle.
